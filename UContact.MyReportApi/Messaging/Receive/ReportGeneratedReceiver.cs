...
{
    public class ReportGeneratedReceiver : BackgroundService
    {
        ...
        public ReportGeneratedReceiver(IReportService reportService, IOptions<RabbitMqConfiguration> rabbitMqOptions)
        {
