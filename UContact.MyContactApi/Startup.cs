...
using UContact.MyContactApi.Infrastructure;
using UContact.MyContactApi.Messaging;
using UContact.MyContactApi.Messaging.Receive;
using UContact.MyContactApi.Messaging.Send;

namespace UContact.MyContactApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<MyContactDbContext>(options =>
            {
        ...
        private void InitializeDatabase(IApplicationBuilder app)
        {
            ...
            using (var context = scope.ServiceProvider.GetRequiredService<MyContactDbContext>())
            {
                try
                {
                    //apply migrations
